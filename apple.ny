...
(defun check-rms (rms)
  ...
  (if (> rms -15.00)
      (if (> rms -14.00)
      "Fail (too loud - RMS should range -18 to -14 dB)"
      "Warning (too loud RMS should range -18 to -14 dB)")
  (if (< rms -18.00)
          (if (< rms -19.00)
              "Fail (too quiet - RMS should range -18 to -14 dB)"
                  "Warning (too quiet - RMS should range -18 to -14 dB)")
      "Pass ( -16 +/- 2 dB)")))
