...
(defun check-rms (rms)
  ...
  (if (> rms -13.00)
      (if (> rms -12.00)
      "Fail (too loud - RMS should range -15 to -13 dB)"
      "Warning (too loud RMS should range -15 to -13 dB)")
  (if (< rms -15)
          (if (< rms -16)
              "Fail (too quiet - RMS should range -15 to -13 dB)"
                  "Warning (too quiet - RMS should range -15 to -13 dB)")
      "Pass ( -14 +/- 1 dB)")))
